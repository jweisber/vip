...
\item
  ...
  \end{enumerate}
\item
  Suppose \(A\) and \(B\) are compatible, and that \(B\) and \(C\) are compatible. Does that mean \(A\) and \(C\) are compatible? If yes, justify your answer. If no, describe a counterexample (an example where it's not true).
\end{enumerate}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/eikosex-1} \caption[Example of an eikosogram]{Example of an eikosogram.}\label{fig:eikosex}
\end{marginfigure}

\newthought{We can} visualize independence with an \textbf{\emph{eikosogram}}, which is like an Euler diagram but with rectangles instead of circles. The size of each sector reflects its probability. For example, in Figure \ref{fig:eikosex} the proposition \(A \wedge B\) has low probability (\(1/12\)), while \(\neg A \wedge B\) has much higher probability (\(1/2\)).

\begin{marginfigure}
\includegraphics{_main_files/figure-latex/eikosindex-1} \caption[Example of an eikosogram where $A$ and $B$ are independent]{Example of an eikosogram where $A$ and $B$ are independent.}\label{fig:eikosindex}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-49-1} \caption[Mutually exclusive propositions don't overlap]{Mutually exclusive propositions don't overlap}\label{fig:unnamed-chunk-49}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-50-1} \caption[Independent propositions do overlap (unless one of them has zero probability)]{Independent propositions do overlap (unless one of them has zero probability).}\label{fig:unnamed-chunk-50}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-51-1} \caption[The Tautology Rule]{The Tautology Rule. Every point falls in either the $A$ region or the $\neg A$ region, so $\p(A \vee \neg A) = 1$.}\label{fig:unnamed-chunk-51}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/equivrule-1} \caption[The Equivalence Rule]{The Equivalence Rule. The $A \vee B$ region is identical to the $B \vee A$ region, so they have the same probability.}\label{fig:equivrule}
\end{marginfigure}
...
\begin{longtable}[]{@{}cc@{}}
\caption{\label{tab:unnamed-chunk-52}Translating between events and propositions}\tabularnewline
\toprule
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-54-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-54-2} \caption[Conditional probability in a fair die roll]{Conditional probability in a fair die roll}\label{fig:unnamed-chunk-54}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/urntree-1} \caption[Tree diagram for an urn problem]{Tree diagram for an urn problem}\label{fig:urntree}
\end{marginfigure}
...
Curiously, the answer is no. Suppose someone has equal chances of having been born in the spring, summer, fall, or winter. Let \(A\) say that they were born in either spring or summer; let \(B\) say they were born in either summer or fall; and let \(C\) say they were born in either fall or winter. Pairwise these propositions are all independent. But \(\p(A \wedge B \wedge C) = 0\) by the Contradiction rule, since there is no season shared by all three propositions; they cannot all be true. And yet \(\p(A)\p(B)\p(C) = 1/8\).
...
\newthought{We} learned rules for \(\vee\) and \(\wedge\) back in \protect\hyperlink{calculating-probabilities}{Chapter 5}.
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-58-1} \caption[The Negation Rule]{The Negation Rule. $\p(\neg A) = 1 - \p(A)$.}\label{fig:unnamed-chunk-58}
\end{marginfigure}
...
\newthought{Notice} that this rule can be flipped around, to calculate the probability of a positive statement:
\[ 
  \p(A) = 1 - \p(\neg A).
\]
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-59-1} \caption[The General Addition Rule in an Euler diagram]{The General Addition Rule in an Euler diagram.}\label{fig:unnamed-chunk-59}
\end{marginfigure}
...
\includegraphics[width=0.15in]{img/emoji_shades_small} and
\includegraphics[width=0.15in]{img/emoji_hearts_small} ) to the two leaves where \(B\) is true (
\includegraphics[width=0.15in]{img/emoji_shades_small} and
\includegraphics[width=0.15in]{img/emoji_nerd_small} ). So we've double-counted the \(A \wedge B\) leaf (
\includegraphics[width=0.15in]{img/emoji_shades_small} ). To get \(\p(A \vee B)\) then, we have to subtract one of those \(A \wedge B\) leaves (
\includegraphics[width=0.15in]{img/emoji_shades_small} ).
...
\begin{figure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-61-7} \caption[Tree diagram for an urn problem]{Tree diagram for an urn problem}\label{fig:unnamed-chunk-61}
\end{figure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-63-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-63-2} \caption[Building a probability tree to solve Laplace's urn puzzle]{Building a probability tree to solve Laplace's urn puzzle}\label{fig:unnamed-chunk-63}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-64-7} \caption[The Law of Total Probability calculates the size of the $A$ region by summing its two parts]{The Law of Total Probability calculates the size of the $A$ region by summing its two parts.}\label{fig:unnamed-chunk-64}
\end{marginfigure}
...
We can also use a tree diagram to illustrate the same reasoning. There are two leaves where \(A\) is true, marked with emoji. To get the probability of each leaf we multiply across the branches (that's the General Multiplication Rule). And then to get the total probability for \(A\), we add up the two leaves: \(\p(A) =\)
\includegraphics[width=0.15in]{img/emoji_shades_small} \(+\)
\includegraphics[width=0.15in]{img/emoji_hearts_small} . Once again the result is the Law of Total Probability:
\[
  \p(A) = \p(A \given B) \p(B) + \p(A \given \neg B) \p(\neg B).
\]
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-67-3} \caption[A probability tree for Professor X]{A probability tree for Professor X}\label{fig:unnamed-chunk-67}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-72-1} \caption[An Euler diagram for visualizing Bayes' theorem]{An Euler diagram for visualizing Bayes' theorem}\label{fig:unnamed-chunk-72}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=2.12in]{img/moon} \caption[The hammer/feather experiment was performed on the moon in 1971. See the \href{https://bit.ly/1KLQzOB}{full video here}.]{The hammer/feather experiment was performed on the moon in 1971. See the \href{https://bit.ly/1KLQzOB}{full video here}.}\label{fig:unnamed-chunk-85}
\end{marginfigure}
...
\newthought{We've} learned a lot about using probability to draw conclusions, but what about making decisions? A lot of reasoning is \emph{practical}: it's not just about what to believe, it's about what to \emph{do}. Once you know how likely the various possible outcomes of a decision are, how do you make your choice?
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/expnegpos-9} \caption[A gamble with one negative payoff, one positive]{A gamble with one negative payoff, one positive}\label{fig:expnegpos}
\end{marginfigure}

\newthought{When} an outcome loses money and the dolllar amount is negative, the diagram extends below the \(x\)-axis. We colour this region red, to indicate that its area is to be subtracted, rather than added.
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-89-1} \caption[A gamble with three possible outcomes]{A gamble with three possible outcomes}\label{fig:unnamed-chunk-89}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-91-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-91-2} \caption[Take the train to Ottawa or drive?]{Take the train to Ottawa or drive?}\label{fig:unnamed-chunk-91}
\end{marginfigure}
...
\begin{longtable}[]{@{}lcc@{}}
\toprule
& A & No A\tabularnewline
\midrule
\endhead
Don't Study & \(\$100\) & \(\$0\)\tabularnewline
Study & \(\$50\) & \(-\$50\)\tabularnewline
\bottomrule
\end{longtable}
...
People have different desires, needs, and interests. Some value friendship most, others value family more. Some prioritize professional success, others favour activism. Some people like eighties music, others prefer hip-hop---and still others, to my constant surprise, enjoy reggae.
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-102-1} \caption[A utility scale for lunch options]{A utility scale for lunch options}\label{fig:unnamed-chunk-102}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-103-1} \caption[A friend's utility scale for lunch options]{A friend's utility scale for lunch options}\label{fig:unnamed-chunk-103}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/uscale-9} \caption[A utility scale with some points of comparison chosen for display]{A utility scale with some points of comparison chosen for display: $u = 7/8$, $2/3$, $1/2$, and $1/6$}\label{fig:uscale}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-105-9} \caption[The best possible gamble]{The best possible gamble}\label{fig:unnamed-chunk-105}
\end{marginfigure}
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-106-9} \caption[An intermediate gamble]{An intermediate gamble}\label{fig:unnamed-chunk-106}
\end{marginfigure}
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-107-9} \caption[The worst possible gamble]{The worst possible gamble}\label{fig:unnamed-chunk-107}
\end{marginfigure}
...
\item
  ...
  \midrule
  \endhead
  \(A\) & \(a_1\) & \(a_2\)\tabularnewline
  \(B\) & \(b_1\) & \(b_2\)\tabularnewline
  \bottomrule
  \end{longtable}
...
\begin{marginfigure}
\includegraphics[width=0.91in]{img/allais} \caption[Maurice Allais (1911--2010), photograph by Harcourt Studios]{Maurice Allais (1911--2010), photograph by Harcourt Studios}\label{fig:unnamed-chunk-109}
\end{marginfigure}
\begin{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=1.67in]{img/ellsberg} \caption[Daniel Ellsberg (b. \(1931\)) is most famous as the leaker of \href{https://bit.ly/1Lgsq2D}{the Pentagon Papers}. The 2017 movie \href{https://bit.ly/2CcHs8v}{\emph{The Post}} tells that story, with Ellsberg portrayed by actor Matthew Rhys. (Photograph by Bernd Gross.)]{Daniel Ellsberg (b. \(1931\)) is most famous as the leaker of \href{https://bit.ly/1Lgsq2D}{the Pentagon Papers}. The 2017 movie \href{https://bit.ly/2CcHs8v}{\emph{The Post}} tells that story, with Ellsberg portrayed by actor Matthew Rhys. (Photograph by Bernd Gross.)}\label{fig:unnamed-chunk-112}
\end{marginfigure}
...
\begin{longtable}[]{@{}lccc@{}}
\caption{\label{tab:unnamed-chunk-113}The Ellsberg paradox}\tabularnewline
\toprule
...
\item
  ...
  \begin{longtable}[]{@{}llll@{}}
  \toprule
  & \(T_1\) & \(T_2\) & \(T_3\)\tabularnewline
  \midrule
  \endhead
  \(A\) & \(a_1\) & \(a_2\) & \(a_3\)\tabularnewline
  \(B\) & \(b_1\) & \(b_2\) & \(b_3\)\tabularnewline
  \bottomrule
  \end{longtable}
...
\newthought{Infinity} poses a different sort of challenge to expected utility. In this chapter we'll meet two famous examples.
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/logutil-9} \caption[Bernoulli's logarithmic utility function]{Bernoulli's logarithmic utility function}\label{fig:logutil}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=1in]{img/pascal} \caption[Blaise Pascal (1623--1662)]{Blaise Pascal (1623--1662)}\label{fig:unnamed-chunk-115}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=1.83in]{img/flanders} \caption[Ned Flanders informs us that, well sir, there are two schools of thought on the matter]{Ned Flanders informs us that, well sir, there are two schools of thought on the matter.}\label{fig:unnamed-chunk-117}
\end{marginfigure}
...
\caption{\label{tab:unnamed-chunk-126}A Dutch book for Suzy the Scientist}\tabularnewline
\toprule
& & \(E\) & \(\neg E\)\tabularnewline
\midrule
\endfirsthead
...
\item
  ...
  \end{enumerate}
\item
  True or false: if someone has personal probabilities \(\p(A \wedge B) = \p(A \vee B)\), then they can be Dutch booked.
\end{enumerate}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-130-9} \caption[A North American roulette wheel]{A North American roulette wheel}\label{fig:unnamed-chunk-130}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=1.33in]{img/bertrand} \caption[Joseph Bertrand (1822--1900) presented this paradox in $1889$]{Joseph Bertrand (1822--1900) presented this paradox in $1889$. He used a different example though. Our example, which is easier to understand, comes from  Bas van Fraassen.}\label{fig:unnamed-chunk-132}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/binom100-9} \caption[The probability of getting $k$ heads out of $100$ flips of a fair coin]{The probability of getting $k$ heads out of $100$ flips of a fair coin.}\label{fig:binom100}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=0.89in]{img/fisher} \caption[Ronald A]{Ronald A. Fisher (1890--1962) was a key figure in establishing the ideas behind statistical significance.}\label{fig:unnamed-chunk-135}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/binom100fences99-9} \caption[In $99\%$ of cases, a fair coin will land heads between $37$ and $63$ times out of $100$ flips]{In $99\%$ of cases, a fair coin will land heads between $37$ and $63$ times out of $100$ flips.}\label{fig:binom100fences99}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/napprox-9} \caption[A bell curve (red) overlayed on the true probabilities (blue)]{A bell curve (red) overlayed on the true probabilities (blue).}\label{fig:napprox}
\end{marginfigure}
...
\newthought{Let's} do one more example for practice. A company named VisioPerfect makes ``long-life'' lightbulbs. According to their ads, \(96\%\) of their bulbs outlast their competitors' average lifespan.
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-151-1} \caption[The result $k = 36$ out of $n = 48$ is easily statistically significant for the null hypothesis $p = .25$]{The result $k = 36$ out of $n = 48$ is easily statistically significant for the null hypothesis $p = .25$.}\label{fig:unnamed-chunk-151}
\end{marginfigure}
...
\newthought{In} \protect\hyperlink{indargs}{Section} \ref{indargs} we noticed that many inductive arguments have a certain format.
...
\begin{marginfigure}
\includegraphics[width=0.74in]{img/goodman} \caption[Nelson Goodman (1906--1988) discovered the grue paradox in the $1940$s and '$50$s]{Nelson Goodman (1906--1988) discovered the grue paradox in the $1940$s and '$50$s.}\label{fig:unnamed-chunk-165}
\end{marginfigure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/gruegraph-9} \caption[The definition of grue]{The definition of grue}\label{fig:gruegraph}
\end{figure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/gruebleengraph-9} \caption[Defining bleen, a counterpart to grue]{Defining bleen, a counterpart to grue}\label{fig:gruebleengraph}
\end{figure}
