...
\newthought{This} book is designed for introductory philosophy courses
...
\newthought{The} book was made using the \texttt{bookdown} package
...
\begin{longtable}[]{@{}cc@{}}
\caption{\label{tab:unnamed-chunk-31}Truth table for
\(\neg\)}\tabularnewline
\toprule
\(A\) & \(\neg A\)\tabularnewline
\midrule
...
\begin{longtable}[]{@{}ccc@{}}
\caption{\label{tab:unnamed-chunk-32}Truth table for
\(\wedge\)}\tabularnewline
\toprule
...
\begin{longtable}[]{@{}ccc@{}}
\caption{\label{tab:unnamed-chunk-33}Truth table for
\(\vee\)}\tabularnewline
\toprule
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-58-1} \caption[The Tautology Rule]{The Tautology Rule. Every point falls in either the $A$ region or the $\neg A$ region, so $\p(A \vee \neg A) = 1$.}\label{fig:unnamed-chunk-58}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-59-1} \caption[The Equivalence Rule]{The Equivalence Rule. The $A \vee B$ region is identical to the $B \vee A$ region, so they have the same probability.}\label{fig:unnamed-chunk-59}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-63-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-63-2} \caption[Conditional probability in a fair die roll]{Conditional probability in a fair die roll}\label{fig:unnamed-chunk-63}
\end{marginfigure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-64-1} \caption[Tree diagram for an urn problem]{Tree diagram for an urn problem}\label{fig:unnamed-chunk-64}
\end{figure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-69-1} \caption[The General Addition Rule in an Euler diagram]{The General Addition Rule in an Euler diagram.}\label{fig:unnamed-chunk-69}
\end{marginfigure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-71-7} \caption[Tree diagram for an urn problem]{Tree diagram for an urn problem}\label{fig:unnamed-chunk-71}
\end{figure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-73-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-73-2} \caption[Building a probability tree to solve Laplace's urn puzzle]{Building a probability tree to solve Laplace's urn puzzle}\label{fig:unnamed-chunk-73}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-75-1} \caption[The Law of Total Probability in a tree diagram]{The Law of Total Probability in a tree diagram}\label{fig:unnamed-chunk-75}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-77-5} \caption[A probability tree for Professor X]{A probability tree for Professor X}\label{fig:unnamed-chunk-77}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-82-1} \caption[An Euler diagram for visualizing Bayes' theorem]{An Euler diagram for visualizing Bayes' theorem}\label{fig:unnamed-chunk-82}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-96-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-96-2} \caption[Take the train to Ottawa or drive?]{Take the train to Ottawa or drive?}\label{fig:unnamed-chunk-96}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-107-1} \caption[A utility scale for lunch options]{A utility scale for lunch options}\label{fig:unnamed-chunk-107}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-111-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-111-2} \includegraphics{_main_files/figure-latex/unnamed-chunk-111-3} \caption[The best possible gamble (top), the worst possible gamble (middle), and an intermediate gamble (bottom)]{The best possible gamble (top), the worst possible gamble (middle), and an intermediate gamble (bottom)}\label{fig:unnamed-chunk-111}
\end{marginfigure}
...
movie \href{https://bit.ly/2CcHs8v}{\emph{The Post}} tells that story,
with Ellsberg portrayed by actor Matthew Rhys. (Photograph by Bernd
Gross).}\label{fig:unnamed-chunk-117}
\end{marginfigure}
...
\begin{longtable}[]{@{}lccc@{}}
\caption{\label{tab:unnamed-chunk-118}The Ellsberg paradox}\tabularnewline
\toprule
...
\begin{marginfigure}
\includegraphics[width=1.83in]{img/flanders} \caption[Ned Flanders informs us that, well sir, there are two schools of thought on the matter]{Ned Flanders informs us that, well sir, there are two schools of thought on the matter.}\label{fig:unnamed-chunk-121}
\end{marginfigure}
...
\caption{\label{tab:unnamed-chunk-129}A Dutch book for Suzy the
...
\begin{marginfigure}
\includegraphics[width=0.89in]{img/fisher} \caption[Ronald A]{Ronald A. Fisher ($1890$--$1962$) established significance testing as a standard scientific method with his influential $1925$ book *Statistical Methods for Research Workers*.}\label{fig:unnamed-chunk-140}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-153-1} \caption[The result $k = 36$ out of $n = 48$ is easily statistically significant for the null hypothesis $p = .25$]{The result $k = 36$ out of $n = 48$ is easily statistically significant for the null hypothesis $p = .25$.}\label{fig:unnamed-chunk-153}
\end{marginfigure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/lindley-11} \caption[An illustration of Lindley's paradox]{An illustration of Lindley's paradox. The finding $k = 36$ doesn't fit well with either hypothesis, so both are rejected. But it fits one of them (red) much better than the other (blue). So the red hypothesis is more plausible from an intuitive perspective.}\label{fig:lindley}
\end{figure}
...
\begin{marginfigure}
\includegraphics[width=1.33in]{img/hume} \caption[David Hume ($1711$--$1776$) raised the problem of induction in $1739$]{David Hume ($1711$--$1776$) raised the problem of induction in $1739$. Our presentation of it here is somewhat modernized from his original argument.}\label{fig:unnamed-chunk-172}
\end{marginfigure}
