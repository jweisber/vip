...
Leonhard Euler (prounounced \emph{oiler}).\footnote{Leonhard Euler lived
...
have seen Venn diagrams before, which are very similar. But in Euler
diagrams the circles don't have to overlap.
...
\begin{longtable}[]{@{}cc@{}}
\caption{\label{tab:unnamed-chunk-58}Translating between events and
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-72-7} \caption[The Law of Total Probability calculates the size of the $A$ region by summing its two part]{The Law of Total Probability calculates the size of the $A$ region by summing its two part.}\label{fig:unnamed-chunk-72}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-80-5} \caption[An Euler diagram for visualizing Bayes' theorem]{An Euler diagram for visualizing Bayes' theorem}\label{fig:unnamed-chunk-80}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-91-1} \caption[A gamble with one negative payoff, one positive]{A gamble with one negative payoff, one positive}\label{fig:unnamed-chunk-91}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-109-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-109-2} \includegraphics{_main_files/figure-latex/unnamed-chunk-109-3} \caption[The best possible gamble (top), the worst possible gamble (middle), and an intermediate gamble (bottom)]{The best possible gamble (top), the worst possible gamble (middle), and an intermediate gamble (bottom)}\label{fig:unnamed-chunk-109}
\end{marginfigure}
...
movie \href{https://bit.ly/2CcHs8v}{\emph{The Post}} tells that story,
with Ellsberg portrayed by actor Matthew Rhys. (Photograph by Bernd
Gross).}\label{fig:unnamed-chunk-115}
\end{marginfigure}
...
\begin{longtable}[]{@{}lccc@{}}
\caption{\label{tab:unnamed-chunk-116}The Ellsberg paradox}\tabularnewline
\toprule
...
\caption{\label{tab:unnamed-chunk-127}A Dutch book for Suzy the
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-129-1} \caption[Prior vs]{Prior vs. posterior probabilities in a die-roll problem. $H$ $=$ the die landed $4$, $5$, or $6$. $E$ $=$ the die landed even. $Pr(H) = 1/2$, $Pr^*(H) = 2/3$.}\label{fig:unnamed-chunk-129}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-131-1} \caption[A North American roulette wheel]{A North American roulette wheel}\label{fig:unnamed-chunk-131}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=0.89in]{img/fisher} \caption[Ronald A]{Ronald A. Fisher ($1890$--$1962$) established significance testing as a standard scientific method with his influential $1925$ book *Statistical Methods for Research Workers*.}\label{fig:unnamed-chunk-138}
\end{marginfigure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-166-11} \caption[The definition of grue]{The definition of grue}\label{fig:unnamed-chunk-166}
\end{figure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-168-1} \caption[Defining bleen, a counterpart to grue]{Defining bleen, a counterpart to grue}\label{fig:unnamed-chunk-168}
\end{figure}
...
\begin{marginfigure}
\includegraphics[width=1.33in]{img/hume} \caption[David Hume ($1711$--$1776$) raised the problem of induction in $1739$]{David Hume ($1711$--$1776$) raised the problem of induction in $1739$. Our presentation of it here is somewhat modernized from his original argument.}\label{fig:unnamed-chunk-170}
\end{marginfigure}
