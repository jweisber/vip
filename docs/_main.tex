...
\newthought{Suppose} a university has 10,000 students, and each student is studying under one of four broad headings: Humanities, Social Sciences, STEM, or Professional. Within each of these categories, the number of students with an average grade of A, B, C, or D is as follows:
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-66-1} \caption[The Negation Rule]{The Negation Rule. $\p(\neg A) = 1 - \p(A)$.}\label{fig:unnamed-chunk-66}
\end{marginfigure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-69-7} \caption[Tree diagram for an urn problem]{Tree diagram for an urn problem}\label{fig:unnamed-chunk-69}
\end{figure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-71-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-71-2} \caption[Building a probability tree to solve Laplace's urn puzzle]{Building a probability tree to solve Laplace's urn puzzle}\label{fig:unnamed-chunk-71}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-79-11} \caption[An Euler diagram for visualizing Bayes' theorem]{An Euler diagram for visualizing Bayes' theorem}\label{fig:unnamed-chunk-79}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=2.12in]{img/moon} \caption[The hammer/feather experiment was performed on the moon in 1971. See the \href{https://bit.ly/1KLQzOB}{full video here}.]{The hammer/feather experiment was performed on the moon in 1971. See the \href{https://bit.ly/1KLQzOB}{full video here}.}\label{fig:unnamed-chunk-91}
\end{marginfigure}
\begin{marginfigure}
\includegraphics[width=2in]{img/vacuum} \caption[It's also been performed in vacuum chambers here on earth. A beautifully filmed example is \href{https://bit.ly/10hw8mP}{available on YouTube}, courtesy of the BBC.]{It's also been performed in vacuum chambers here on earth. A beautifully filmed example is \href{https://bit.ly/10hw8mP}{available on YouTube}, courtesy of the BBC.}\label{fig:unnamed-chunk-91}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-94-1} \caption[A gamble with one negative payoff, one positive]{A gamble with one negative payoff, one positive}\label{fig:unnamed-chunk-94}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-95-1} \caption[A gamble with three possible outcomes]{A gamble with three possible outcomes}\label{fig:unnamed-chunk-95}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-97-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-97-2} \caption[Take the train to Ottawa or drive?]{Take the train to Ottawa or drive?}\label{fig:unnamed-chunk-97}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-108-1} \caption[A utility scale for lunch options]{A utility scale for lunch options}\label{fig:unnamed-chunk-108}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-109-1} \caption[A friend's utility scale for lunch options]{A friend's utility scale for lunch options}\label{fig:unnamed-chunk-109}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-112-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-112-2} \includegraphics{_main_files/figure-latex/unnamed-chunk-112-3} \caption[The best possible gamble (top), the worst possible gamble (middle), and an intermediate gamble (bottom)]{The best possible gamble (top), the worst possible gamble (middle), and an intermediate gamble (bottom)}\label{fig:unnamed-chunk-112}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=0.91in]{img/allais} \caption[Maurice Allais (1911--2010), photograph by Harcourt Studios]{Maurice Allais (1911--2010), photograph by Harcourt Studios}\label{fig:unnamed-chunk-114}
\end{marginfigure}
\begin{marginfigure}
...
\begin{longtable}[]{@{}lccc@{}}
\caption{\label{tab:unnamed-chunk-116}Savage's version of the Allais paradox, using a lottery with \(100\) tickets}\tabularnewline
\toprule
...
\begin{marginfigure}
\includegraphics[width=1.67in]{img/ellsberg} \caption[Daniel Ellsberg (b. \(1931\)) is most famous as the leaker of \href{https://bit.ly/1Lgsq2D}{the Pentagon Papers}. The 2017 movie \href{https://bit.ly/2CcHs8v}{\emph{The Post}} tells that story, with Ellsberg portrayed by actor Matthew Rhys. (Photograph by Bernd Gross).]{Daniel Ellsberg (b. \(1931\)) is most famous as the leaker of \href{https://bit.ly/1Lgsq2D}{the Pentagon Papers}. The 2017 movie \href{https://bit.ly/2CcHs8v}{\emph{The Post}} tells that story, with Ellsberg portrayed by actor Matthew Rhys. (Photograph by Bernd Gross).}\label{fig:unnamed-chunk-118}
\end{marginfigure}
...
\begin{longtable}[]{@{}lccc@{}}
\caption{\label{tab:unnamed-chunk-119}The Ellsberg paradox}\tabularnewline
\toprule
...
\begin{marginfigure}
\includegraphics[width=1in]{img/pascal} \caption[Blaise Pascal (1623--1662)]{Blaise Pascal (1623--1662)}\label{fig:unnamed-chunk-121}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=1.83in]{img/flanders} \caption[Ned Flanders informs us that, well sir, there are two schools of thought on the matter]{Ned Flanders informs us that, well sir, there are two schools of thought on the matter.}\label{fig:unnamed-chunk-122}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-123-1} \caption[A bet that pays $\$1$ if you win and costs $\$2$ if you lose, is fair when the blue and red regions have equal size]{A bet that pays $\$1$ if you win and costs $\$2$ if you lose, is fair when the blue and red regions have equal size: when the probability of winning is $2/3$.}\label{fig:unnamed-chunk-123}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-124-1} \caption[A bet that pays $\$9$ if you win and costs $\$1$ if you lose is fair when the probability of winning is $1/10$]{A bet that pays $\$9$ if you win and costs $\$1$ if you lose is fair when the probability of winning is $1/10$.}\label{fig:unnamed-chunk-124}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-132-1} \caption[Prior vs]{Prior vs. posterior probabilities in a die-roll problem. $H$ $=$ the die landed $4$, $5$, or $6$. $E$ $=$ the die landed even. $Pr(H) = 1/2$, $Pr^*(H) = 2/3$.}\label{fig:unnamed-chunk-132}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=0.89in]{img/fisher} \caption[Ronald A]{Ronald A. Fisher (1890--1962) established significance testing as a standard scientific method with his influential $1925$ book *Statistical Methods for Research Workers*.}\label{fig:unnamed-chunk-141}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-154-1} \caption[The result $k = 36$ out of $n = 48$ is easily statistically significant for the null hypothesis $p = .25$]{The result $k = 36$ out of $n = 48$ is easily statistically significant for the null hypothesis $p = .25$.}\label{fig:unnamed-chunk-154}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-155-1} \caption[The result $k = 36$ out of $n = 48$ is also statistically significant for the null hypothesis $p = .5$]{The result $k = 36$ out of $n = 48$ is also statistically significant for the null hypothesis $p = .5$.}\label{fig:unnamed-chunk-155}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics[width=0.74in]{img/goodman} \caption[Nelson Goodman (1906--1988) discovered the grue paradox in the $1940$s and '$50$s]{Nelson Goodman (1906--1988) discovered the grue paradox in the $1940$s and '$50$s.}\label{fig:unnamed-chunk-168}
\end{marginfigure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-169-1} \caption[The definition of grue]{The definition of grue}\label{fig:unnamed-chunk-169}
\end{figure}
...
\begin{figure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-171-1} \caption[Defining bleen, a counterpart to grue]{Defining bleen, a counterpart to grue}\label{fig:unnamed-chunk-171}
\end{figure}
