...
\begin{marginfigure}
\includegraphics{_main_files/figure-latex/unnamed-chunk-70-1} \includegraphics{_main_files/figure-latex/unnamed-chunk-70-2} \caption[Building a probability tree to solve Laplace's urn puzzle]{Building a probability tree to solve Laplace's urn puzzle}\label{fig:unnamed-chunk-70}
\end{marginfigure}
...
\item
  ...
  \item
    ...
    infinite.
  \item
    The paradox reappears if we alter the dollar amounts of the payoffs
    so that the utility doubles with each flip.
  \end{enumerate}
\item
...
\newthought{How} do we Dutch book someone who mistakenly thinks
